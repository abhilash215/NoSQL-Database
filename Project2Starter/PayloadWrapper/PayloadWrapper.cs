///////////////////////////////////////////////////////////////
// PayloadWrapper.cs -Wrapper supports cloning and ToString()//
// Ver 1.1                                                   //
 ...
 *------------------
 *Main()
 *-main method  used to test the Payload Wrapper
 *
/*
 * Maintenance:
 * ------------
...
namespace Project2_code
{
  public abstract class PayloadWrapper<key, Data> where Data : new()
  {
    ...
    override abstract public string ToString();       //returns a string 
